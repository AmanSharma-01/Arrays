...
// and Mirko raises his sawblade to 15 metres, the remaining tree heights after cutting will 
// be 15, 15, 10, and 15 metres, respectively, while Mirko will take 5 metres off the first tree 
// and 2 metres off the fourth tree (7 metres of wood in total).
...
// Help Mirko find the maximum integer height of the sawblade that still allows him to cut off at least 
// M metres of wood.
...
// than 1 000 000 000, the heights of each tree (in metres). The sum of all heights will exceed M, 
...
int main()
{
    ...
    cout<<"the maximum height is "<<ans;
    return 0;
}